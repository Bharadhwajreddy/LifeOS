      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[61] rounded-t-3xl max-h-[90vh] overflow-y-auto overscroll-contain"
            style={{ background: 'var(--surface)', WebkitOverflowScrolling: 'touch' }}
          >
            {/* Drag handle */}
